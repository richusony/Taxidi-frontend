            ...
            <div className='w-[80%] relative'>
                <div className='mt-2 h-screen relative border-2 border-y'>
                    ...
                    <div key="messagesContainer" className="px-3 h-[81vh] overflow-auto scroll-smooth">
                        ...
                        {realTimeMessages && realTimeMessages.map((msgs) => msgs.msgFrom == "taxidi@gmail.com" ? (
                            <div key={msgs._id} ref={lastMessage} className="my-2 w-full flex justify-end">
                    ...
                    <div>
                        <div className='flex absolute w-full bottom-0 z-50'>
                            <textarea defaultValue={inputMsg} className='outline-none border-2 w-full border-[#593CFB] px-2 py-1 rounded' onChange={(e) => setInputMsg(e.target.value)} placeholder='write something...' name="reviewMsg" id="reviewMsg"></textarea>
